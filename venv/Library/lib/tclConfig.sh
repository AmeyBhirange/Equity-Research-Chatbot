...
# installed.
TCL_PREFIX='D:/College/Sem 6/Projects/Equity Research Chatbot/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/College/Sem 6/Projects/Equity Research Chatbot/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/College/Sem 6/Projects/Equity Research Chatbot/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/College/Sem 6/Projects/Equity Research Chatbot/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/College/Sem 6/Projects/Equity Research Chatbot/venv\Library\lib tclstub86.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='C:\ci\tk_1654036608655\work\tcl8.6.12\win\Release_AMD64_VC1916\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='D:/College/Sem 6/Projects/Equity Research Chatbot/venv\Library\lib\tclstub86.lib'
